...
const journalApi = {
  ...
  getJournalToday: async () => {
    try {
      const response = await apiClient.get('/api/administrator/monitored/get/journal/today');
  ...
  getJournalTodayByTeacher: async () => {
    try {
      const response = await apiClient.get('/api/teacher/monitored/get/all/student/journal/today/by/teacher');
